...
// Aggiungete una funzionalità basica di scorrimento delle immagini: per cui ogni 3 secondi il carosello mostrerà l'immagine successiva senza bisogno di alcuna interazione da parte dell'utente.

const clock = setInterval(timeToSlide, 3000);
